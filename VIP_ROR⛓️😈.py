...
\nBy ميسي \n:『@FF22L 』⏎'\n\n\t\t\t\t\t
					...
					infoakun += f''' ▄︻デ══━一 MESSI «𝗢𝗞 ميسي   جبلك حساب شغال 🤩⚜️
 » ⏎
...
اميره :لاتنسه صور الصيد『@FF22L 』⏎'''
					...
					HAXOi('\n')
					statusok = f''' ▄︻デ══━一 «𝗢𝗞  جابلك ميسي حساب شغال 🤩⚜️
 » ⏎
